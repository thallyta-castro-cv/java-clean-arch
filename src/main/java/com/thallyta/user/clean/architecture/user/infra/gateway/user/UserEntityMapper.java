...
public class UserEntityMapper {
    ...
    public UserEntity toEntity(User user) {
        return new UserEntity(user.getId(), user.getCpf(), user.getName(), user.getBornDate(), user.getEmail());
    }

    public User toDomain(UserEntity userEntity) {
        return new User(userEntity.getId(), userEntity.getCpf(), userEntity.getName(), userEntity.getBornDate(), userEntity.getEmail());
    }
}
